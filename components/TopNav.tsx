...
export function TopNav() {
  return (
    <header className="flex h-16 items-center justify-between border-b border-slate-200/60 bg-white/80 backdrop-blur-md px-6 sticky top-0 z-50">
      <div className="flex flex-1 items-center">
        <div className="relative w-full max-w-md group">
          ...
          <input
            type="text"
            className="block w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pl-10 pr-3 text-slate-900 placeholder:text-slate-400 focus:border-teal-500/50 focus:bg-white focus:outline-none focus:ring-1 focus:ring-teal-500/50 text-sm transition-all"
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-3 pl-5 border-l border-slate-200">
          <div className="bg-slate-50 px-4 py-1.5 rounded-lg border border-slate-200 flex items-center gap-2 hidden md:flex cursor-pointer hover:bg-slate-100 transition-colors">
            <span className="text-sm text-slate-500">Cliente:</span>
            <span className="text-sm font-semibold text-slate-800">Aura Cosméticos</span>
